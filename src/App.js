          ...
          <Navbar color="indigo" dark expand="lg" fixed="top" double scrolling>
            ...
            <Collapse id="mainNavbarCollapse" isOpen={this.state.collapseID} navbar>
              <NavbarNav>
                ...
                <NavItem>
                  <NavLink onClick={this.closeCollapse('mainNavbarCollapse')} to="/bartonization" >
                    Bart
                  </NavLink>
                </NavItem>
                <NavItem>
                ...
                <NavItem>
                  <NavLink onClick={this.closeCollapse('mainNavbarCollapse')} to="/test">
                    Test
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink onClick={this.closeCollapse('mainNavbarCollapse')} to="/tabs">
                    Tabs
                  </NavLink>
                </NavItem>
                <NavItem>
